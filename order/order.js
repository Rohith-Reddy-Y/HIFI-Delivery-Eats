      ...
      if (!orderJustPlaced) {
        cartItemsContainer.innerHTML = `
          <div class="empty-cart-container">
            <img src="cart.png" alt="Empty Cart" class="empty-cart-image" onerror="this.onerror=null; this.src='https://via.placeholder.com/150?text=Cart+Image+Not+Found'; console.log('Failed to load cart.png at ../images/cart.png');" />
